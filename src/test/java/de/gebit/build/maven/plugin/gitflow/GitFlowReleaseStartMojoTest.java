...
public class GitFlowReleaseStartMojoTest extends AbstractGitFlowMojoTestCase {
    ...
    @Test
    public void testExecuteInstallProjectTrueAndInstallProjectOnReleaseStartFalse() throws Exception {
        // set up
        git.createAndCommitTestfile(repositorySet);
        git.push(repositorySet);
        Properties userProperties = new Properties();
        userProperties.setProperty("flow.installProject", "true");
        userProperties.setProperty("flow.installProjectOnReleaseStart", "false");
        when(promptControllerMock.prompt(PROMPT_RELEASE_VERSION, POM_RELEASE_VERSION)).thenReturn(RELEASE_VERSION);
        // test
        executeMojo(repositorySet.getWorkingDirectory(), GOAL, userProperties, promptControllerMock);
        // verify
    ...
    @Test
    public void testExecuteInstallProjectFalseAndInstallProjectOnReleaseStartTrue() throws Exception {
        // set up
        git.createAndCommitTestfile(repositorySet);
        git.push(repositorySet);
        Properties userProperties = new Properties();
        userProperties.setProperty("flow.installProject", "false");
        userProperties.setProperty("flow.installProjectOnReleaseStart", "true");
        when(promptControllerMock.prompt(PROMPT_RELEASE_VERSION, POM_RELEASE_VERSION)).thenReturn(RELEASE_VERSION);
        // test
        executeMojo(repositorySet.getWorkingDirectory(), GOAL, userProperties, promptControllerMock);
        // verify
    ...
    @Test
    public void testExecuteInstallProjectGoalsOnReleaseStartSet() throws Exception {
        // set up
        git.createAndCommitTestfile(repositorySet);
        git.push(repositorySet);
        Properties userProperties = new Properties();
        userProperties.setProperty("flow.installProject", "true");
        userProperties.setProperty("flow.installProjectGoalsOnReleaseStart", "validate -Dabc=install");
        when(promptControllerMock.prompt(PROMPT_RELEASE_VERSION, POM_RELEASE_VERSION)).thenReturn(RELEASE_VERSION);
        // test
        executeMojo(repositorySet.getWorkingDirectory(), GOAL, userProperties, promptControllerMock);
        // verify
        ...
        assertEquals(MASTER_BRANCH, branchConfig.getProperty("baseBranch"));
        assertVersionsInPom(repositorySet.getWorkingDirectory(), RELEASE_VERSION);
        assertMavenCommandExecuted("validate -Dabc=install");
    ...
    public void testExecuteWithBaseBranchAndBaseCommitOnReleaseTag() throws Exception {
        // set up
        final String RELEASE_TAG = "gitflow-tests-" + RELEASE_VERSION;
        final String BASE_COMMIT = git.currentCommit(repositorySet);
        git.createTags(repositorySet, true, RELEASE_TAG);
        git.createAndCommitTestfile(repositorySet);
        git.push(repositorySet);
        Properties userProperties = new Properties();
        userProperties.setProperty("baseBranch", MASTER_BRANCH);
    ...
    public void testExecuteWithBaseBranchAndBaseCommitOnReleaseTagWithoutReleaseTagPrefix() throws Exception {
        // set up
        final String RELEASE_TAG = RELEASE_VERSION;
        final String BASE_COMMIT = git.currentCommit(repositorySet);
        git.createTags(repositorySet, true, RELEASE_TAG);
        git.createAndCommitTestfile(repositorySet);
        git.push(repositorySet);
    ...
    public void testExecuteWithBaseBranchAndBaseCommitAfterMergeIntoProduction() throws Exception {
        ...
        final String EXPECTED_PRODUCTION_SAVEPOINT = git.currentCommit(repositorySet);
        git.switchToBranch(repositorySet, MASTER_BRANCH);
        ...
        assertEquals(MASTER_BRANCH, branchConfig.getProperty("baseBranch"));
        assertEquals(EXPECTED_DEVELOPMENT_COMMIT, branchConfig.getProperty("developmentSavepointCommitRef"));
        assertEquals(EXPECTED_PRODUCTION_SAVEPOINT, branchConfig.getProperty("productionSavepointCommitRef"));
        assertVersionsInPom(repositorySet.getWorkingDirectory(), RELEASE_VERSION);
    }
    ...
    @Test
    public void testExecuteAbortBeforeReleaseStart() throws Exception {
        // set up
        git.createAndCommitTestfile(repositorySet);
        git.push(repositorySet);
        final String EXPECTED_DEVELOPMENT_COMMIT = git.currentCommit(repositorySet);
    ...
    @Test
    public void testExecuteAbortBeforeReleaseStartOnMaster() throws Exception {
        // set up
        git.createAndCommitTestfile(repositorySet);
        git.push(repositorySet);
        final String EXPECTED_DEVELOPMENT_COMMIT = git.currentCommit(repositorySet);
    ...
    @Test
    public void testExecuteAbortBeforeReleaseStartOnBaseCommitOnMaster() throws Exception {
        // set up
        final String BASE_COMMIT = git.currentCommit(repositorySet);
        git.createAndCommitTestfile(repositorySet);
        git.push(repositorySet);
