...
public class GitFlowFeatureRebaseMojo extends AbstractGitFlowFeatureMojo {
        ...
        if (!continueOnCleanInstall) {
            ...
            if (featureBranchName == null) {
                ...
                if (StringUtils.isNotEmpty(branchName)) {
                    ...
                    getLog().info("Rebasing feature on specified feature branch: " + featureBranchName);
                    ...
                    if (!isOnFeatureBranch) {
                        ...
                        gitEnsureBranchExistsAndLocalBranchIsUpToDate(featureBranchName,
                                new GitFlowFailureInfo("Remote and local feature branches '{0}' diverge.",
                                        "Rebase or merge the changes in local feature branch '{0}' first.",
                                        "'git rebase'"),
                                createBranchNotExistingError("Selected feature branch '" + branchName + "'",
                                        "Please select an existing feature branch in order to proceed."));
                    } else {
                        featureBranchName = currentBranch;
                ...
                continueFeatureRebase(confirmedUpdateWithMerge, featureBranchName);
                baseBranch = gitFeatureBranchBaseBranch(featureBranchName);
        ...
        if (confirmedUpdateWithMerge) {
            ...
            if (versionChangeCommitOnBranch != null) {
                ...
                if (!currentVersion.equals(version)) {
                    ...
                    versionChangeCommit = mvnSetVersions(version, GitFlowAction.FEATURE_REBASE, "On feature branch: ",
                            featureBranch, sameBaseVersion, featureBranch, featureStartMessage);
                ...
                try {
                    ...
                    String rebasePausedLogMessage = "Feature rebase process paused to resolve rebase conflicts";
    ...
    private void continueFeatureRebase(boolean confirmedUpdateWithMerge, String featureBranch)
