...
public abstract class AbstractGitFlowReleaseMojo extends AbstractGitFlowMojo {
	...
	/**
	 * Perfom the steps to finish a release. Must be called on a release branch. It will merge the branch either to
	 * development/production or maintenance, depending on configuration and branch point.
	 *
