...
public class GitFlowEpicUpdateMojo extends AbstractGitFlowEpicMojo {
    ...
    /**
     * Maven goals (separated by space) to be used after epic update. By default
     * the value of <code>installProjectGoals</code> parameter
     * (<code>flow.installProjectGoals</code> property) is used.
     *
     * @since 2.3.1
     */
    @Parameter(property = "flow.installProjectGoalsOnEpicUpdate")
    private String installProjectGoalsOnEpicUpdate;
    ...
    protected void executeGoal() throws CommandLineException, MojoExecutionException, MojoFailureException {
        ...
        if (!continueOnCleanInstall) {
            ...
            if (oldEpicVersion != null) {
                ...
                if (versionlessMode.needsVersionChangeCommit() && confirmedUpdateWithMerge && !baseVersion.equals(oldBaseVersion) && !tychoBuild) {
    ...
    private void updateEpicByMerge(String epicBranch, String baseBranch, String baseVersion, String oldBaseVersion)
        ...
        if (versionlessMode.needsVersionChangeCommit() && !tychoBuild && !baseVersion.equals(oldBaseVersion)) {
            String issueNumber = getEpicIssueNumber(epicBranch);
    ...
    protected String getIndividualInstallProjectGoals() {
        return installProjectGoalsOnEpicUpdate;
    }
